...
for i, row in index.iterrows():
    ...
    corrected_image = utils.image_utils.correct_color_balance(img, avg_bg_color, strength=1)
    ...
    corrected_image = utils.image_utils.reduce_yellow(corrected_image, preview=preview, name=row["en_name"], tolerance=30)
